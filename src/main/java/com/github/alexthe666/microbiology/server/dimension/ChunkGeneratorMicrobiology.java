...
public class ChunkGeneratorMicrobiology implements IChunkGenerator {
    protected static final IBlockState STONE = MicrobiologyBlockRegistry.CONGEALED_MICROBIAL_SEDIMENT.getDefaultState();
    ...
    private IBlockState oceanBlock = MicrobiologyFluidRegistry.OOZE.getDefaultState();
    ...
    double[] depthRegion;
    private static final int SEA_LEVEL = 61;

    public ChunkGeneratorMicrobiology(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        {
        ...
        if (generatorOptions != null) {
            ...
            this.oceanBlock = this.settings.useLavaOceans ? Blocks.LAVA.getDefaultState() : MicrobiologyFluidRegistry.OOZE.getDefaultState();
